const filme = [
  {
    ...
    beschreibung:
      "Ein Soldat wird auf den Planeten Pandora geschickt und muss zwischen der Menschheit und den Na'vi wählen.",
  ...
  },
  {
    ...
    genre: "Drama/Romance",
    beschreibung:
      "Eine Liebesgeschichte auf dem berühmten Schiff, das im Nordatlantik sank.",
  ...
  },
  {
    ...
    genre: "Science Fiction",
    beschreibung:
      "Ein junger Held kämpft gegen das böse Imperium in einer weit entfernten Galaxie.",
  ...
  },
  {
    ...
    jahr: 2000,
    genre: "Science Fiction",
    beschreibung: "Junge wird Spinne",
    bild: "https://i.ebayimg.com/00/s/MTYwMFgxMDY2/z/FQUAAOSwt9JgOARA/$_57.JPG?set_id=8800005007",
  },
];
